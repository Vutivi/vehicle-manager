...
class RegisterPage extends Component {
    ...
    handleSubmit(e) {
        ...
        UserService.register(username, email, password, first_name, last_name)
            .then(
                user => {
    ...
    render() {
        const { username, email, first_name, last_name, password, submitted, loading, error } = this.state;
        return (
            <div className="col-md-6 col-md-offset-3" style={{margin: "auto", width: "50%" }}>
                <h2>Login</h2>
